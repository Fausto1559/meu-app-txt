...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050B14] text-slate-100 flex flex-col font-sans relative">
      ...
      <header className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 my-auto shadow-2xl text-white max-h-[85vh] overflow-y-auto z-10 relative bg-slate-800/90 text-white p-6 rounded-xl border border-slate-700 shadow-lg">
        ...
        <div className="flex flex-col-reverse md:flex-col md:flex-col md:flex-row items-center gap-4">
          ...
          <div className="relative">
            ...
            {isUpgradeOpen && (
              <div className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 my-auto shadow-2xl text-white max-h-[85vh] overflow-y-auto z-10 relative bg-slate-800/90 text-white p-6 rounded-xl border border-slate-700 shadow-lg">
      ...
      <main className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 my-auto shadow-2xl text-white max-h-[85vh] overflow-y-auto z-10 relative bg-slate-800/90 text-white p-6 rounded-xl border border-slate-700 shadow-lg">
        {activeTab === 'painel' && (
                ...
                <div className="space-y-2.5">
                  {contasReceber.length > 0 ? (
                    contasReceber.map((item) => (
                      <div key={item.id} className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 my-auto shadow-2xl text-white max-h-[85vh] overflow-y-auto z-10 relative bg-slate-800/90 text-white p-6 rounded-xl border border-slate-700 shadow-lg">
                        <div>
