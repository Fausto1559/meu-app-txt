    ...
    <div className="min-h-screen bg-[#050B14] text-slate-100 flex flex-col font-sans relative">
      ...
      <div className="bg-red-900/90 text-white px-6 py-2 grid grid-cols-1 md:grid-cols-3 items-center text-xs gap-2 border-b border-red-800">
        ...
        <div className="text-center">
          ...
          <strong className="text-amber-400 font-mono">27d 5h 50m 30s</strong>
        </div>

        {/* 3. Direita: Status do Caixa */}
        <div className="flex items-center gap-2 justify-end">
          <span>Status do caixa:</span>
          <span className="bg-red-600 text-white font-bold px-2 py-0.5 rounded text-[10px] tracking-wider">VERMELHO</span>
        </div>
