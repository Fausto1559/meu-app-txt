                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-slate-900/90 border border-emerald-500/40 rounded-xl p-4 flex flex-col justify-between space-y-4 relative shadow-md">
                    ...
                    <div className="space-y-2 pt-1">
                      ...
                      <div className="text-lg font-bold text-emerald-400 font-mono">R$ 19,90<span className="text-[10px] text-slate-400 font-normal">/m�s</span></div>
                  ...
                  <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-4 flex flex-col justify-between space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="text-lg font-bold text-amber-400 font-mono">R$ 29,90<span className="text-[10px] text-slate-400 font-normal">/mês</span></div>
                  ...
                  <div className="bg-slate-900/90 border border-amber-500/50 rounded-xl p-4 flex flex-col justify-between space-y-4 shadow-lg relative">
                ...
                <div className="space-y-2.5">
                  {contasReceber.length > 0 ? (
                    contasReceber.map((item) => (
                      <div key={item.id} className="bg-slate-900/60 p-2.5 rounded-lg border border-slate-800/80 flex items-center justify-between">
                        <div>
        ...
        {activeTab === 'fechamento_contador' && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-sm font-bold text-white">Central Contador / Fim de Mês</h2>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-[#0A1428] border border-slate-800 rounded-xl p-4 space-y-2.5 shadow-sm">
                ...
                <div className="space-y-2 text-xs text-slate-300">
                  <div className="flex justify-between py-1 border-b border-slate-800"><span>Contas Pagas no Mês:</span> <strong className="font-mono text-white">R$ 12.200,00</strong></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div className="space-y-3">
                {['Stone / Ton', 'Redecard', 'Getnet'].map((operadora, idx) => {
                  ...
                  return (
                    <div key={idx} className="bg-[#0A1428] border border-slate-800 rounded-xl p-3 flex items-center justify-between shadow-sm">
                      <div className="flex items-center gap-2.5">
