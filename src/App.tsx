...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#050B14] text-slate-100 flex flex-col font-sans relative">
      ...
      <header className="relative w-full max-w-5xl bg-slate-900 relative border border-slate-700 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-2xl p-6 sm:p-8 my-auto shadow-2xl z-10 text-white max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex flex-col-reverse md:flex-col md:flex-col md:flex-row items-center gap-4">
          <div className="bg-slate-800/60 relative border border-slate-700 bg-slate-800/80 rounded-xl p-5 pt-8 text-white pt-8/50 px-3 py-1 rounded-full flex items-center gap-2 text-xs">
      ...
      <main className="relative w-full max-w-5xl bg-slate-900 relative border border-slate-700 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-2xl p-6 sm:p-8 my-auto shadow-2xl z-10 text-white max-h-[90vh] overflow-y-auto">
        {activeTab === 'painel' && (
          <div className="space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 w-full">
              <div className="bg-[#0A1428] relative border border-slate-800 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-xl p-3 space-y-1.5 relative shadow-sm">
            ...
            <div className="bg-[#0A1428] relative border border-slate-800 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-xl p-3.5 flex items-center justify-between shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 w-full">
              <div className="bg-[#0A1428] relative border border-slate-800 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-xl p-4 space-y-3 shadow-sm">
                ...
                <div className="space-y-2.5">
                  {contasReceber.length > 0 ? (
                    contasReceber.map((item) => (
                      <div key={item.id} className="relative w-full max-w-5xl bg-slate-900 relative border border-slate-700 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-2xl p-6 sm:p-8 my-auto shadow-2xl z-10 text-white max-h-[90vh] overflow-y-auto">
                        <div>
        ...
        {activeTab === 'fechamento_contador' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 w-full">
              <div className="bg-[#0A1428] relative border border-slate-800 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-xl p-4 space-y-2.5 shadow-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 w-full">
              <div className="space-y-3">
                {['Stone / Ton', 'Redecard', 'Getnet'].map((operadora, idx) => {
                  ...
                  return (
                    <div key={idx} className="bg-[#0A1428] relative border border-slate-800 bg-slate-800/80 rounded-xl p-5 pt-8 text-white rounded-xl p-3 flex items-center justify-between shadow-sm">
                      <div className="flex items-center gap-2.5">
