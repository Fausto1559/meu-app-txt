  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#0c1527] flex items-center justify-center text-white p-4">
        <div className="bg-[#14223c] p-8 rounded-xl border border-slate-700 max-w-md w-full text-center space-y-5 shadow-2xl">
          <div>
            <h2 className="text-2xl font-bold text-white">Copiloto Financeiro</h2>
            <p className="text-slate-400 text-sm mt-1">Você desconectou da sua conta.</p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <button 
              type="button"
              onClick={() => {
                // Adicione aqui a função do Firebase para Google Auth
              }} 
              className="w-full bg-white hover:bg-slate-100 text-slate-900 font-medium py-2.5 px-4 rounded-lg flex items-center justify-center gap-3 border border-slate-300 transition-all cursor-pointer text-sm"
            >
            ...
            <div className="relative flex py-1 items-center">
              ...
              <span className="flex-shrink mx-3 text-xs text-slate-500 uppercase tracking-wider">ou</span>
              <div className="flex-grow border-t border-slate-700"></div>
            </div>

            {/* 2. RECEBER LINK PELO EMAIL */}
            <div className="space-y-2">
              <input
                type="email"
                placeholder="seu.email@exemplo.com"
                className="w-full bg-[#0c1527] border border-slate-700 rounded-lg px-3 py-2 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-amber-500"
              />
              <button 
                type="button"
                onClick={() => {
                  // Adicione aqui a função para envio de link mágico por e-mail
                }} 
                className="w-full bg-slate-800 hover:bg-slate-700 text-slate-200 font-medium py-2 px-4 rounded-lg border border-slate-600 transition-all cursor-pointer text-sm"
              >
          ...
          {/* 3. BOTÃO LARANJA AJUSTADO PARA "Fazer Login" */}
          <div className="pt-2 border-t border-slate-800">
            <button 
              type="button"
              onClick={() => window.location.reload()} 
              className="w-full bg-amber-500 hover:bg-amber-600 text-slate-950 font-bold py-2.5 rounded-lg transition-all cursor-pointer shadow-lg text-sm"
            >
              Fazer Login
            </button>
          </div>
