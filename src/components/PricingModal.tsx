  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 shadow-2xl text-white max-h-[85vh] overflow-y-auto">
        <button onClick={onClose} className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6 w-full">
          ...
          <div className="relative w-full max-w-5xl bg-slate-900 border border-slate-700 rounded-2xl p-6 sm:p-8 shadow-2xl text-white max-h-[85vh] overflow-y-auto">
            <div>
              ...
              <ul className="relative space-y-2 text-xs text-slate-300 border-t border-slate-800 pt-3 relative bg-slate-800/90 text-white p-6 rounded-xl border border-slate-700 shadow-lg">
            ...
            <button onClick={() => { if(onSelectPlan) onSelectPlan('essencial', 'Freemium / Essencial', 0); onClose(); }} className="relative mt-6 w-full bg-slate-800 hover:bg-slate-700 py-2.5 rounded-lg text-xs font-bold transition-all">Selecionar Essencial</button>
          </div>
