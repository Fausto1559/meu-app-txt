  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 overflow-y-auto">
      <div className="relative w-full max-w-4xl bg-slate-900 border border-slate-700 rounded-2xl p-6 my-auto shadow-2xl z-10 text-slate-100 max-h-[88vh] overflow-y-auto">
        <button onClick={onClose} className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 overflow-y-auto">
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 my-4 w-full">
          ...
          {/* Card 3: Copiloto Pro */}
          <div className="relative w-full max-w-4xl bg-slate-900 border border-slate-700 rounded-2xl p-6 my-auto shadow-2xl z-10 text-slate-100 max-h-[88vh] overflow-y-auto">
            <span className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 overflow-y-auto">Recomendado</span>
            <div>
