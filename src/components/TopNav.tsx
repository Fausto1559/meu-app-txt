...
export default function TopNav({ onOpenUpgrade }: TopNavProps) {
  ...
  return (
    <div className="flex flex-col-reverse sm:flex-col md:flex-row items-center gap-2">
      <div className="px-3 py-1 rounded-full bg-slate-900 relative border border-slate-800 bg-slate-800/80 rounded-xl p-5 pt-8 text-white text-[10px] sm:text-xs text-slate-300">
