...
export function Perfil({ onClose, userData }: any) {
  ...
  return (
    <div className="bg-slate-900 text-white p-6 rounded-2xl w-full border border-slate-800 shadow-2xl space-y-6">
      ...
      <div className="space-y-3">
        ...
        {/* BOTÃO EXPORTAR DADOS (LARGURA TOTAL) */}
        <button
          onClick={handleExportData}
          className="w-full bg-slate-800 hover:bg-slate-700 text-slate-200 py-2.5 px-4 rounded-xl font-medium border border-slate-700 text-sm transition-all text-center"
        >
